...
int main ()
{
    while (1) {
        ...
        int skipped = 0;
        vector <vector <deque <int>>> oldpile;
        vector <queue <int>> olddeck;
        int same = 0;
        while (1) {
            skipped = 0;
            same = 0;
            for (int i = 0; i < 7; i++) {
                if (pile[i].empty())
                    ...
                    for (int i = 0; i < (int) oldpile.size(); i++) {
                        if ((oldpile[i] == pile) && (olddeck[i] == deck))
                            same = 1;
                    }
                    ...
                    oldpile.push_back(pile);
                    olddeck.push_back(deck);
